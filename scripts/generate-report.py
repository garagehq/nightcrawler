...
def generate_report(output_path="logs/report.md", network_id=None):
    ...
    md.append(f"**Agent:** Nightcrawler v0.1.0 — Qwen3.5-2B on OnePlus 8 (Kali NetHunter)")
    md.append("")
    ...
    md.append(f"*Platform: OnePlus 8 (Snapdragon 865) running Kali NetHunter with Qwen3.5-2B GPU inference*")
